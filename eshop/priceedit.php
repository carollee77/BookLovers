...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <div id="middletxtheadermain">
      <div id="middletxtheader">Product Management</div>
      <div id="middletxt1">
 ...
 <?php
  $get= @mysql_query("SELECT * FROM prod_price_tbl WHERE username= '$username' AND prd_id='$pid' ")or die(mysql_error());
...
<?php
 if($_POST['submitMain'])
 {
  ...
  $query = mysql_query("UPDATE prod_price_tbl SET price_actual='$pact',price_discount='$pdis',
