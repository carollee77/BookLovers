...
<div id="container">
 ...
 $adjacents = 3;
	...
	$query="SELECT COUNT(*) as num FROM backup_trn_tbl WHERE username = '$username' AND bck_archive='$date'";
	...
	$get= @mysql_query("SELECT * FROM backup_trn_tbl WHERE username = '$username' AND bck_archive='$date' LIMIT $start, $limit ")or die(mysql_error());
