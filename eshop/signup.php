...
<div id="container">
<div id="meun"><a href="../eshop/booklovers/index.php">BookLovers Home</a>
 ...
 <a href="../eshop/booklovers/contact.php">Contact</a>
    <a href="../eshop/booklovers/aboutus.php">About us</a>
     ...
     <br></div>
 <div align="center">  <img src="../eshop/images/finnal2.gif" alt="Online Book Store" width="950" height="200" /></div>
  ...
  <div id="sidebar1">
    <div id="subsidebar1">
      ...
      <div id="subsidebar2"><a href="aboutus.php">About this Site</a>
      </div>
    </div>
    <!-- end #sidebar1 -->
  </div>
            ...
            <tr>
              ...
              <tr>
                 ...
                 <td width="128"><input type="textbox" name="txtsin_username" id="txtsin_username" maxlength="20" style="width:176px;"
                                  ...
                                  <div class="example">(Only Lower case, alpha numeric characters Allowed.)</div>
              ...
              <tr>
               ...
               <tr>
                 ...
                 <td width="200"><input type="textbox" name="txtsin_url" id="txtsin_url" maxlength="40" style="width:176px;"
                                   onChange="document.getElementById('txtsin_url').value=trim(this.value);"/><div class="example">(Eg.http://localhost/booklovers/'UserName'/)</div></td></td>
              </tr>
              <tr>
...
<?php
  if(isset($_POST['submitMain']))
  {
   ...
   $about=$_POST['ta_about'];
    ...
    $get= @mysql_query("SELECT * FROM admin_acct_tbl")or die(mysql_error());
   ...
   $query = mysql_query("INSERT INTO vendor_tbl
