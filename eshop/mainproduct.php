...
<div id="subsidebar2">
 ...
 <?php
                      ...
                      $get_scatgry=mysql_query("SELECT DISTINCT(prd_sub_cat)  FROM product_tbl WHERE prd_cat='$category' AND username = '$username' AND prd_status='Available'  ")or die(mysql_error());
                       //echo ("SELECT cat_sub_category FROM prod_category_tbl WHERE cat_category='$cat_category' ");
 ...
 ?>
  ...
  <div id="mainContent">
	...
	$query="SELECT COUNT(*) as num FROM product_tbl WHERE username= '$username' AND prd_cat= '$cat' AND prd_sub_cat= '$sub' AND prd_status='Available' ";
	...
	<!-- MSTableType="layout" -->
<?php
    $get= @mysql_query("SELECT * FROM product_tbl WHERE username= '$username' AND prd_cat= '$cat' AND prd_sub_cat= '$sub' AND prd_status='Available' LIMIT $start, $limit ")or die(mysql_error());
