...
<div id="container">
  ...
  <div id="sidebar1">
    <div id="subsidebar1">
      ...
      <div id="subsidebar2"><a href="admlogout.php" onclick="return isConfirmlog();" >Log out</a>
      </div>
    </div>
    <!-- end #sidebar1 -->
  </div>
...
<!-- Code for inserting into data base -->
 <?php
  ...
  {
   $get= @mysql_query("SELECT * FROM admin_acct_tbl WHERE adm_username= '$username' ")or die(mysql_error());
   ...
   if($old_password == $old){
    if($old == $password) {
      ...
      $query = mysql_query("UPDATE admin_acct_tbl SET adm_password='$password' WHERE adm_username='$username' ")
                           or die(mysql_error());
