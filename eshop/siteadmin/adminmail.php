...
<div id="container">
  ...
  <div id="sidebar1">
    <div id="subsidebar1">
      ...
      <div id="subsidebar2"><a href="admlogout.php" onclick="return logoutcon();">Log out</a>
      </div>
    </div>
    <!-- end #sidebar1 -->
  </div>
              ...
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selemail" id="selemail" style="width:300px;">
                        ...
                        <?php
                        $get_email= @mysql_query("SELECT log_email FROM vendor_tbl")or die(mysql_error());
  ...
  <div id="footer">
    (C) Copyright Carol & Natalie Production Company
    <!-- end #footer -->
  </div>
  <!-- end #container -->
</div>
