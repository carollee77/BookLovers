...
<div id="container">
 ...
 $adjacents = 3;
	...
	if($page)
 	...
 	$query="SELECT COUNT(*) as num FROM orders_tbl WHERE username = '$username' AND ord_deliverystatus= 'Delivered'";
	...
	$get= @mysql_query("SELECT * FROM orders_tbl WHERE username='$username' AND ord_deliverystatus= 'Delivered' LIMIT $start, $limit ")or die(mysql_error());
