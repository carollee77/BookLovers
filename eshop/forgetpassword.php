...
<div id="meun"><a href="../eshop/booklovers/index.php">BookLovers Home</a>
 ...
 <div align="center">  <img src="../eshop/images/finnal2.gif" alt="Online Book Store" width="950" height="200" /></div>
  ...
  <div id="sidebar1">
    <div id="subsidebar1">
      ...
      <div id="subsidebar2"><a href="index.php">Home</a></div>
      <div id="subsidebar2"><a href="signup.php">Register</a>
 ...
 if(isset($_POST['submitMain']))
 {
  ...
  //echo $user;
  $get_user= @mysql_query("SELECT log_fname,log_email,log_password FROM vendor_tbl WHERE username= '$user' ")or die(mysql_error());
