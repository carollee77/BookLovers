<?php
  session_start();
   ...
   $sid=$_SESSION['sid'];
    $count=@mysql_query("SELECT * from orders_tbl WHERE username='$username' AND ord_sid='$sid'");
...
<?php
  $get= @mysql_query("SELECT * FROM orders_tbl WHERE username= '$username' AND ord_sid='$sid'")or die(mysql_error());
