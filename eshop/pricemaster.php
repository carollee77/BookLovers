...
<div id="container">
  ...
  <div id="sidebar1">
    <div id="subsidebar1">
      ...
      <div id="subsidebar2"><a href="logout.php" onClick="return isConfirmlog();" >Log out</a>
      </div>
    </div>
    <!-- end #sidebar1 -->
  </div>
  <div id="mainContent">
    ...
    <div id="middletxtheadermain">
      <div id="middletxtheader">Price Management</div>
      <div id="middletxt1">
          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  <tr>
                    <th colspan="5" id="formhedear">Price Management</th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><select name="selpid" id="selpid" style="width:180px;">
                        ...
                        <?php
                        $get_pid= @mysql_query("SELECT prd_id FROM product_tbl WHERE username= '$username' ")or die(mysql_error());
 ...
 <?php
  if($_POST['submitMain'])
  {
   ...
   $pedate=$_POST['txt_edate'];
    ...
    $get=mysql_query("select * from prod_price_tbl where username='$username' AND prd_id = '$pid' ");
    if(mysql_num_rows($get)==0)
    {
     $query = mysql_query("INSERT INTO prod_price_tbl(username,prd_id,price_actual,price_discount,price_discount_type)
                          VALUES ('$username','$pid','$pact','$pdis','$pdiscount')")
                          or die(mysql_error());
      echo "<script>alert('Price Details inserted sucessfully !!');</script>";
    } else {
     $query = mysql_query("UPDATE prod_price_tbl SET price_actual='$pact',price_discount='$pdis',price_discount_type='$pdiscount'
