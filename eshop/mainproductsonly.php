...
<?php
	...
	$query="SELECT COUNT(*) as num FROM product_tbl WHERE username= '$username' AND prd_cat= '$cat' AND prd_status='Available' ";
...
?>
<?php
    $get= @mysql_query("SELECT * FROM product_tbl WHERE username= '$username' AND prd_cat= '$cat' AND prd_status='Available' LIMIT $start, $limit ")or die(mysql_error());
