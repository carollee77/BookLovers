...
<div id="mainContent">
        ...
        <table width="100%" border=0>
          <tr>
           ...
           <td><select name="selpid" id="selpid" style="width:180px;">
               ...
               <?php
                $get_pid= @mysql_query("SELECT DISTINCT prd_id FROM orders_tbl WHERE username= '$username' AND ord_deliverystatus= 'Delivered'")or die(mysql_error());
          ...
          <tr>
           ...
           <td><select name="seldate" id="seldate" style="width:180px;">
               ...
               <?php
                $get_date= @mysql_query("SELECT DISTINCT ord_odate FROM orders_tbl WHERE ord_deliverystatus= 'Delivered' AND username= '$username' ORDER BY ord_odate DESC ")or die(mysql_error());
                $num_date= @mysql_num_rows($get_date);
                for($i=0;$i<$num_date;$i++)
                {
 ...
 <?php
  ...
  {
   $get= @mysql_query("SELECT * FROM orders_tbl WHERE username='$username' AND prd_id='$dpid' AND ord_deliverystatus= 'Delivered'")or die(mysql_error());
 ...
 <?php
       ...
       {
	$get= @mysql_query("SELECT * FROM orders_tbl WHERE username='$username' AND ord_odate='$ddate' AND ord_deliverystatus= 'Delivered'")or die(mysql_error());
        $num = @mysql_num_rows($get);
        for($i=0;$i<$num;$i++)
        {
         $prid= @mysql_result($get,$i,'prd_id');
 ...
 <?php
	...
	$get= @mysql_query("SELECT * FROM orders_tbl WHERE username='$username' AND prd_id='$dpid' AND ord_odate='$ddate' AND ord_deliverystatus= 'Delivered'")or die(mysql_error());
        $num = @mysql_num_rows($get);
        for($i=0;$i<$num;$i++)
        {
         $prid= @mysql_result($get,$i,'prd_id');
