...
<div id="container">
 ...
 <?php
  $adjacents = 3;
	...
	$query="SELECT COUNT(*) as num FROM orders_tbl WHERE username = '$username' AND ord_deliverystatus= 'Waiting'";
    ...
    $get= @mysql_query("SELECT * FROM orders_tbl WHERE username='$username' AND ord_deliverystatus= 'Waiting' LIMIT $start, $limit ")or die(mysql_error());
