          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selemail" id="selemail" style="width:300px;">
                        ...
                        <?php
                        $get_email= @mysql_query("SELECT DISTINCT ord_email FROM orders_tbl WHERE username='$username' ")or die(mysql_error());
			 ...
			 <option value="<?php echo $email;?>"><?php echo $email;?></option>
                        ...
                        $get_email= @mysql_query("SELECT DISTINCT bck_email FROM backup_trn_tbl WHERE username='$username' ")or die(mysql_error());
                        $num= @mysql_num_rows($get_email);
                        for($i=0;$i<$num;$i++)
                        {
