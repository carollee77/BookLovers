...
<div id="container">
          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  <tr>
                    <th colspan="5" id="formhedear">Product Management</th>
                  </tr>
                  <tr>
			...
			<option value="Inches">Inches</option>
                  ...
                  <tr>
                    ...
                    <td><select name="selprdcat" id="selprdcat" style="width:180px;" onChange="showdiv();displaysubcat(this.value);">
                        ...
                        <?php
                        $get_catgry=mysql_query("SELECT DISTINCT cat_category FROM prod_category_tbl")or die(mysql_error());
  ...
  <?php
   $photo = mysql_query ("SELECT MAX(row_id) FROM product_tbl");
...
<!-- Code for inserting into data base -->
 <?php
  if(isset($_POST['submitMain']) && ($size < 350000) && !$imageval=="")
  {
   ...
   $query = mysql_query("INSERT INTO product_tbl
