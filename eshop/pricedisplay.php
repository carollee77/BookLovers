          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  <tr>
                    <th colspan="5" id="formhedear">Price Management Display Page.</th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><select name="selpid" id="selpid" style="width:180px;">
                        ...
                        <?php
                        $get_pid= @mysql_query("SELECT prd_id FROM prod_price_tbl WHERE username= '$username' ")or die(mysql_error());
